...
#define MQNAME "/my_mq"
#define MSGSIZE sizeof(Aircraft_t)  // Make sure to size it according to the sizeof(Aircraft_t)
...
//checking if the Aircraft is inside the tracking range
...
int main(int argc, char** argv)
{
    ...
    timer_spec.it_interval.tv_sec = 5; // 5-second period,it'll update
